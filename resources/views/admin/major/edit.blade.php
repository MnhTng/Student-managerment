    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="row">
            <div
                ...
                <h4 class="text-danger mb-3">{{ __('Update Major') }}</h4>

                <form class="needs-validation" method="POST" action="{{ route('major.update', $major->major_code) }}"
                    novalidate>
                    @csrf
