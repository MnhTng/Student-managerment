    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md d-flex justify-content-start justify-content-md-end mt-md-0 mt-3">
                <a href="{{ route('credit-class.create.student', $credit_class->id) }}"
                ...
                <tbody class="table-group-divider">
                    ...
                    @foreach ($classroom as $class)
                        <tr>
                            ...
                            <td>{{ $class->student->class_code }}</td>
                            <td>{{ $class->student->major->major_name }}</td>
                            <td>
                                <div class="d-flex flex-nowrap">
                                    <a href="{{ route('credit-class.edit.student', $class->id) }}"
                                    ...
                                    <button class="delete-student btn btn-sm btn-outline-danger border-0"
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const id = student.getAttribute('data-student');

                                window.location.href =
                                    "{{ route('credit-class.destroy.student', 'id') }}"
                                    .replace('id', id);
                            }
                        });
                    }
