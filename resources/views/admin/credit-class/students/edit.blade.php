    ...
    <div class="container-fluid pt-4 px-4">
                ...
                <nav class="d-flex align-items-center" aria-label="breadcrumb">
                    <ol class="breadcrumb overflow-hidden text-center m-0">
                        ...
                        <li class="breadcrumb-item active d-flex align-items-end" aria-current="page">
                            <span>Cập nhật thành viên lớp</span>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row">
            <div
                ...
                <h4 class="text-danger mb-3">Cập nhật thành viên lớp</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="text"
                                    ...
                                    id="student" name="student" placeholder="Họ tên - Mã sinh viên" list="students"
