    ...
    <div class="container-fluid pt-4 px-4">
                ...
                <nav class="d-flex align-items-center" aria-label="breadcrumb">
                    <ol class="breadcrumb overflow-hidden text-center m-0">
                        ...
                        <li class="breadcrumb-item active d-flex align-items-end" aria-current="page">
                            <span>{{ __('Update Class Member') }}</span>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row">
            <div
                ...
                <h4 class="text-danger mb-3">{{ __('Update Class Member') }}</h4>

                <form class="needs-validation d-grid gap-3" method="POST"
                    action="{{ route('credit-class.update.student', $classroom->id) }}" novalidate>
                    @csrf
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <select class="form-select" id="school_year" name="school_year"
                                    aria-label="Select school year" disabled>
                                    <option class="bg-body" value="{{ $classroom->school_year }}" selected>
                                        {{ 'Kỳ ' . $classroom->school_years->semester . ' năm học ' . $classroom->school_years->school_term }}
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 d-flex justify-content-between">
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="form-control" id="teacher" name="teacher"
                                    value="{{ $classroom->teacher->name }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="{{ __('Full Name') }} - {{ __('Student Code') }}" list="students"
                                    value="{{ old('student') ?? $classroom->student->name . '-' . $classroom->student->msv }}">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <select class="form-select" id="subject" name="subject" aria-label="Select subject"
                                    disabled>
                                    <option class="bg-body" value="{{ $classroom->subject_code }}" selected>
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="datetime-local" class="form-control" id="start_time" name="start_time"
                                    value="{{ $classroom->start_time }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="datetime-local" class="form-control" id="end_time" name="end_time"
                                    value="{{ $classroom->end_time }}" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="{{ route('credit-class.list', $classroom->id) }}"
