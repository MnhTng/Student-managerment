    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md d-flex justify-content-start justify-content-md-end mt-md-0 mt-3">
                <a href="{{ route('student.create') }}" class="btn btn-bd-primary d-flex gap-2 align-items-center p-2"
                ...
                <tbody class="table-group-divider">
                    ...
                    @foreach ($students as $student)
                        <tr>
                            ...
                            <td>{{ $student->formal_class->class_code }}</td>
                            <td>{{ $student->training_system->training_name }}</td>
                            <td>{{ $student->academic_year }}</td>
                            <td>
                                <div class="d-flex flex-nowrap">
                                    <a href="{{ route('student.edit', $student->msv) }}"
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const code = student.getAttribute('data-student');

                                window.location.href =
                                    "{{ route('student.destroy', 'msv') }}"
                                    .replace('msv', code);
                            }
                        });
                    }
