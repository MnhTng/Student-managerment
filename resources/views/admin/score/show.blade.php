...
@section('content')
                        ...
                        <div class="row d-flex justify-content-between">
                            <div class="col-12 col-lg-4 d-grid gap-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-3 fs-5">
                                    ...
                                    <span>
                                        {{ $credit_classes->first()->subject->subject_name }}
                                    </span>
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-3 fs-5">
                                    ...
                                    <span>
                                        {{ $credit_classes->first()->subject->credit }}
                                    </span>
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-3 fs-5">
                                    <span class="d-flex align-items-center gap-3 fw-bold">
                                        ...
                                        <span>{{ __('Number of students') }}:</span>
                                    </span>
                                    <span>
                                        {{ $credit_classes->count() }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-8">
                                <div
                                    ...
                                    <div class="col-lg-4 col-12 d-flex align-items-center justify-content-center">
                                        <img src="@if ($credit_classes->first()->teacher->gender === 'Nam') {{ asset('/uploads/avt/man.png') }} @else {{ asset('/uploads/avt/woman.png') }} @endif"
                                    ...
                                    <div class="col d-grid gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3 mb-3 fs-5">
                                            ...
                                            <span>
                                                {{ $credit_classes->first()->teacher->name }}
                                            </span>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3 mb-3 fs-5">
                                            ...
                                            <span>
                                                {{ $credit_classes->first()->teacher->gender }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        @foreach ($credit_classes as $class)
                            <tr>
                                <th scope="row">{{ $i++ }}</th>
                                <td>
                                    <img src="@if ($class->student->gender === 'Nam') {{ asset('/uploads/avt/boy.png') }} @else {{ asset('/uploads/avt/girl.png') }} @endif"
                                ...
                                <td>
                                    @if (collect($scores)->where('msv', $class->msv)->first())
                                        {{ (float) collect($scores)->where('msv', $class->msv)->first()->score }}
                                    @else
                                        <span class="text-danger">{{ __('Not updated yet!') }}</span>
                                    @endif
                                </td>
                                @php
                                    if (collect($scores)->where('msv', $class->msv)->first()) {
                                        $status = 'update';
                                        $score =
                                            $class->id . '-' . collect($scores)->where('msv', $class->msv)->first()->id;
                                    } else {
                                        $status = 'create';
                                        $score =
                                            $class->id .
                                ...
                                <td>
                                    <div class="d-flex flex-nowrap">
                                        <a href="@if ($status === 'update') {{ route('score.edit', $score) }} @else {{ route('score.create', $score) }} @endif"
    ...
    <div id="import-excel-form" class="d-none d-flex justify-content-center">
        <form action="{{ route('import.score', $id) }}" method="POST" enctype="multipart/form-data">
            @csrf
