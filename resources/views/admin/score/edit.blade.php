            ...
            <div
                ...
                <form class="needs-validation" method="POST"
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="pe-none form-control" id="student" name="student"
                                    value="{{ $score->student->name . '-' . $score->student->msv }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <select class="form-select pe-none" id="school_year" name="school_year"
                                    ...
                                    <option class="bg-body" value="{{ $score->school_year }}" selected>
                                        {{ 'Kỳ ' . $score->school_years->semester . ' năm học ' . $score->school_years->school_term }}
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 d-flex justify-content-between">
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="text" class="pe-none form-control" id="subject" name="subject"
                                    value="{{ $score->subject->subject_name }}">
                            </div>
                        </div>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="{{ route('score.show', $credit_class_id) }}" class="btn btn-outline-danger rounded-1">
                            {{ __('Cancel') }}
                        </a>
                    </div>
                </form>
