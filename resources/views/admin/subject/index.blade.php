    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 col-md d-flex justify-content-start justify-content-md-end mt-md-0 mt-3">
                <a href="{{ route('subject.create') }}" class="btn btn-bd-primary d-flex gap-2 align-items-center p-2"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-nowrap">
                                    <a href="{{ route('subject.edit', $subject->subject_code) }}"
                                    ...
                                    <button class="delete-subject btn btn-sm btn-outline-danger border-0"
                                        data-subject="{{ $subject->subject_code }}">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const code = subject.getAttribute('data-subject');

                                window.location.href =
                                    "{{ route('subject.destroy', 'subject') }}".replace(
                                        'subject', code);
                            }
                        });
                    }
