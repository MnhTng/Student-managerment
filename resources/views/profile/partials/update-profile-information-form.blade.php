<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full text-dark"
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="email" class="mt-1 block w-full text-dark"
