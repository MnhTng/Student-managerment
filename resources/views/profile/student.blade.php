                    ...
                    <div class="col d-grid gap-1">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3 fs-5">
                            ...
                            <span>
                                ...
                                <span
                                    class="@if ($status === __('Studying')) btn btn-outline-primary @else btn btn-outline-danger @endif">
                                    {{ $status }}
                                </span>
                            </span>
                        </div>
